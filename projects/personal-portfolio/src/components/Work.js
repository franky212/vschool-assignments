            ...
            <div>
              ...
              <Modal bsSize="large" show={this.state.showModal2} onHide={() => this.setState({showModal2: false})}>
                ...
                <Modal.Body>
                  ...
                  <p>I’ve been working on a React based app called What’s Going On in my spare time as project work. The premise is having an interactive way to view events that are near a user as well as business' being able to post events to the map for users to see. You can check it out here: <a href="whats-going-on.surge.sh">What's Going On Example</a></p>
                </Modal.Body>
                <Modal.Footer>
            ...
            <div>
              ...
              <Modal bsSize="large" show={this.state.showModal3} onHide={() => this.setState({showModal3: false})}>
                ...
                <Modal.Body>
                  ...
                  <p>This was a group full-stack project <a href="whats-going-on.surge.sh">What's Going On Example</a></p>
                </Modal.Body>
                <Modal.Footer>
