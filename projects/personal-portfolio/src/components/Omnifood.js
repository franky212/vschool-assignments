    ...
    <div>
      ...
      <div style={styles.exampleBody}>
        <div className="example-body">
          <p style={styles.exampleBody.p}>If you would like to view this example live then click this <a rel="noopener noreferrer" target="_blank" href="http://frankdelaguila-omnifood.surge.sh/">link</a>. Deployed using Surge.</p>
